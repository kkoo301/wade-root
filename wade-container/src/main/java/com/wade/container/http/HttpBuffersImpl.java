...
package com.wade.container.http;
...
/* ------------------------------------------------------------ */
/**
 * Abstract Buffer pool. simple unbounded pool of buffers for header, request
 * and response sizes.
 * 
 */
public class HttpBuffersImpl extends AbstractLifeCycle implements HttpBuffers {
	...
	/**
	 * @param responseBufferType
	 *            the responseBufferType to set
	 */
