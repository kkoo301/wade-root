...
import com.wade.container.security.authentication.DeferredAuthentication;
...
import com.wade.container.server.session.AbstractSessionManager;
 ...
 * that start with "com.wade.container.security." that do not have 
...
public abstract class SecurityHandler extends HandlerWrapper implements Authenticator.AuthConfiguration
{
        ...
        throws Exception
    {
        ...
        if (context!=null)
        {
            ...
            while (names!=null && names.hasMoreElements())
            {
                ...
                if (name.startsWith("com.wade.container.security.") &&
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see com.wade.container.server.handler.HandlerWrapper#doStop()
     */
    @Override
    ...
    protected boolean checkSecurity(Request request)
    {
        switch(request.getDispatcherType())
        {
            ...
            case ASYNC:
                return true;
            case FORWARD:
                if (_checkWelcomeFiles && request.getAttribute("com.wade.container.server.welcome") != null)
                {
                    request.removeAttribute("com.wade.container.server.welcome");
                    return true;
                }
                return false;
            default:
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see com.wade.container.security.Authenticator.AuthConfiguration#isSessionRenewedOnAuthentication()
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see com.wade.container.server.Handler#handle(java.lang.String,
