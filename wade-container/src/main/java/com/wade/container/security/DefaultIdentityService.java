 ...
 * associated {@link server.UserIdentity.Scope}.  If there are roles
 * refs present, then associate will wrap the UserIdentity with one
 * that uses the role references in the 
 * {@link server.UserIdentity#isUserInRole(String, server.UserIdentity.Scope)}
...
public class DefaultIdentityService implements IdentityService
{
     ...
     * with one that uses the role references in the {@link UserIdentity#isUserInRole(String, server.UserIdentity.Scope)}
     */
