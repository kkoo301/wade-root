...
public interface Authenticator
{
     ...
     * @return An Authentication.  If Authentication is successful, this will be a {@link server.Authentication.User}. If a response has 
     * been sent by the Authenticator (which can be done for both successful and unsuccessful authentications), then the result will
     * implement {@link server.Authentication.ResponseSent}.  If Authentication is not manditory, then a 
     * {@link server.Authentication.Deferred} may be returned.
     * 
