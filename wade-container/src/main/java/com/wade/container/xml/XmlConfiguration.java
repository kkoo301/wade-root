...
package com.wade.container.xml;
...
import com.wade.container.util.ArrayQueue;
...
import com.wade.container.xml.XmlParser.Node;
...
public class XmlConfiguration
{
    ...
    private synchronized static XmlParser initParser()
    {
        ...
        URL config60 = Loader.getResource(XmlConfiguration.class,"com/wade/container/xml/configure_6_0.dtd",true);
        URL config76 = Loader.getResource(XmlConfiguration.class,"com/wade/container/xml/configure_7_6.dtd",true);
        ...
        AccessController.doPrivileged(new PrivilegedAction<Object>()
        {
            public Object run()
            {
                try
                {
                    ...
                    try
                    {
                        Class<?> config = XmlConfiguration.class.getClassLoader().loadClass("com.wade.container.start.Config");
                        properties = (Properties)config.getMethod("getProperties").invoke(null);
                        LOG.debug("com.wade.container.start.Config properties = {}",properties);
                    }
