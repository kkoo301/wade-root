...
public class DeflateFrameExtension extends AbstractExtension
{
    ...
    /* (non-Javadoc)
     * @see com.wade.container.websocket.AbstractExtension#onFrame(byte, byte, com.wade.container.io.Buffer)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.wade.container.websocket.AbstractExtension#addFrame(byte, byte, byte[], int, int)
     */
    @Override
