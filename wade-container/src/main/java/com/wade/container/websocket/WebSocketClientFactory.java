...
import com.wade.container.io.SimpleBuffers;
...
{
    private final static Logger __log = com.wade.container.util.log.Log.getLogger(WebSocketClientFactory.class.getName());
