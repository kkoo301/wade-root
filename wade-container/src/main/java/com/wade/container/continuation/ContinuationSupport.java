...
public class ContinuationSupport
{
    ...
    static
    {
        ...
        try
        {
            ...
            if (servlet3)
            {
                Class<? extends Continuation> s3c = ContinuationSupport.class.getClassLoader().loadClass("com.wade.container.continuation.Servlet3Continuation").asSubclass(Continuation.class);
        ...
        try
        {
            ...
            if (jetty6)
            {
                Class<? extends Continuation> j6c = ContinuationSupport.class.getClassLoader().loadClass("com.wade.container.continuation.Jetty6Continuation").asSubclass(Continuation.class);
     ...
     * server.AsyncContinuation) or one of the utility
     * implementations provided such as an internal <code>FauxContinuation</code>
     * or a real implementation like {@link continuation.Servlet3Continuation}.
