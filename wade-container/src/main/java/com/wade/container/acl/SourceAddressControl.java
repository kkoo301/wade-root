package com.wade.container.acl;
...
public final class SourceAddressControl {
	...
	private static final Logger LOG = Log.getLogger(SourceAddressControl.class);
	...
	private static final String ACL_FILE = "wade.container.acl";
