...
import com.wade.container.client.security.Authentication;
...
import com.wade.container.io.View;
...
public abstract class AbstractHttpConnection extends AbstractConnection implements Dumpable
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see com.wade.container.util.component.Dumpable#dump()
     */
    public String dump()
    {
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see com.wade.container.util.component.Dumpable#dump(java.lang.Appendable, java.lang.String)
     */
