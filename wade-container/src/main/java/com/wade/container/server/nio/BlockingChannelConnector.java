...
import com.wade.container.io.nio.ChannelEndPoint;
import com.wade.container.server.BlockingHttpConnection;
import com.wade.container.server.Request;
import com.wade.container.util.ConcurrentHashSet;
...
public class BlockingChannelConnector extends AbstractNIOConnector
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see com.wade.container.server.AbstractConnector#doStart()
     */
    @Override
    ...
    private class BlockingChannelEndPoint extends ChannelEndPoint implements Runnable, ConnectedEndPoint
    {
        ...
        /* ------------------------------------------------------------ */
        /**
         * @see com.wade.container.io.nio.ChannelEndPoint#fill(io.Buffer)
         */
        @Override
        ...
        /* ------------------------------------------------------------ */
        /**
         * @see com.wade.container.io.nio.ChannelEndPoint#flush(io.Buffer)
         */
        @Override
        ...
        /* ------------------------------------------------------------ */
        /**
         * @see com.wade.container.io.nio.ChannelEndPoint#flush(io.Buffer, io.Buffer, io.Buffer)
         */
        @Override
