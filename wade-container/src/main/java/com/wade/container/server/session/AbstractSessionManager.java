...
import com.wade.container.server.SessionManager;
...
import com.wade.container.util.statistic.CounterStatistic;
import com.wade.container.util.statistic.SampleStatistic;
...
public abstract class AbstractSessionManager extends AbstractLifeCycle implements SessionManager
{
    ...
    public final static String SESSION_KNOWN_ONLY_TO_AUTHENTICATED="com.wade.container.security.sessionKnownOnlytoAuthenticated";
     ...
     * If SSL offload is used, then the {@link AbstractConnector#customize(io.EndPoint, Request)}
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see com.wade.container.server.SessionManager#setSessionPath(java.lang.String)
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see com.wade.container.server.SessionManager#isCheckingRemoteSessionIdEncoding()
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see com.wade.container.server.SessionManager#setCheckingRemoteSessionIdEncoding(boolean)
     */
