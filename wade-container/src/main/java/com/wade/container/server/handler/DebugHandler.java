...
import com.wade.container.util.RolloverFileOutputStream;
...
public class DebugHandler extends HandlerWrapper
{
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see com.wade.container.server.Handler#handle(java.lang.String, javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse, int)
     */
    @Override
            ...
            throws IOException, ServletException
    {
        ...
        boolean retry=false;
        String name=(String)request.getAttribute("com.wade.container.thread.name");
        if (name==null)
        ...
        finally
        {
            ...
            if (suspend)
            {
                request.setAttribute("com.wade.container.thread.name",name);
    ...
    /* (non-Javadoc)
     * @see com.wade.container.server.handler.HandlerWrapper#doStart()
     */
    @Override
