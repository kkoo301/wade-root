...
public class HandlerCollection extends AbstractHandlerContainer
{
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see com.wade.container.server.server.handler.AbstractHandler#doStart()
     */
    @Override
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see com.wade.container.server.server.handler.AbstractHandler#doStop()
     */
    @Override
     ...
     * @see com.wade.container.server.server.HandlerContainer#addHandler(server.server.Handler)
     */
