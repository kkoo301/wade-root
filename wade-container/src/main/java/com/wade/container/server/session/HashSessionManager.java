 ...
 * set as the "com.wade.container.server.session.timer" attribute of the ContextHandler.
 *
 */
public class HashSessionManager extends AbstractSessionManager
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see com.wade.container.servlet.AbstractSessionManager#doStart()
     */
    @Override
    public void doStart() throws Exception
    {
        ...
        if (context!=null)
            _timer=(Timer)context.getAttribute("com.wade.container.server.session.timer");
        if (_timer==null)
        {
            _timerStop=true;
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see com.wade.container.servlet.AbstractSessionManager#doStop()
     */
    @Override
