 ...
 * 
 * This {@link server.handler.HandlerCollection} is creates a 
 * {@link http.PathMap} to it's contained handlers based
 * on the context path and virtual hosts of any contained {@link server.handler.ContextHandler}s.
...
public class ContextHandlerCollection extends HandlerCollection
{
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see com.wade.container.server.server.handler.HandlerCollection#setHandlers(server.server.Handler[])
     */
    @Override
