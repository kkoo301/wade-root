...
public class DefaultHandler extends AbstractHandler {
	...
	public DefaultHandler() {
		try {
			URL fav = this.getClass().getClassLoader().getResource("com/wade/container/favicon.ico");
			if (null != fav) {
	...
	/*
	 * @see
	 * com.wade.container.server.server.Handler#handle(javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse, int)
	 */
