 ...
 * then use of efficient direct NIO may be prevented, thus use of the gzip mechanism of the <code>servlet.DefaultServlet</code> is advised instead.
 * </p>
 */
public class GzipHandler extends HandlerWrapper
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see com.wade.container.server.handler.HandlerWrapper#handle(java.lang.String, server.Request, javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)
     */
    @Override
