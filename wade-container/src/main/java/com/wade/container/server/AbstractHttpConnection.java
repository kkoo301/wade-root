...
import com.wade.container.continuation.ContinuationThrowable;
import com.wade.container.http.EncodedHttpURI;
import com.wade.container.http.Generator;
import com.wade.container.http.HttpBuffers;
import com.wade.container.http.HttpContent;
...
import com.wade.container.http.HttpHeaderValues;
...
import com.wade.container.http.Parser;
import com.wade.container.io.AbstractConnection;
import com.wade.container.io.Buffer;
import com.wade.container.io.BufferCache.CachedBuffer;
...
import com.wade.container.io.UncheckedPrintWriter;
import com.wade.container.server.nio.NIOConnector;
import com.wade.container.server.ssl.SslConnector;
 ...
 * response code is 101 (switch protocols), then the io.Connection
...
public abstract class AbstractHttpConnection  extends AbstractConnection
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see com.wade.container.io.Connection#isSuspended()
     */
    ...
    private class RequestHandler extends HttpParser.EventHandler
    {
        /*
         *
         * @see com.wade.container.server.server.HttpParser.EventHandler#startRequest(org.eclipse.io.Buffer,
        ...
        /*
         * @see com.wade.container.server.server.HttpParser.EventHandler#parsedHeaderValue(org.eclipse.io.Buffer)
         */
        @Override
        ...
        /*
         * @see com.wade.container.server.server.HttpParser.EventHandler#headerComplete()
         */
        @Override
        ...
        /* ------------------------------------------------------------ */
        /*
         * @see com.wade.container.server.server.HttpParser.EventHandler#content(int, org.eclipse.io.Buffer)
         */
        @Override
         ...
         * (non-Javadoc)
         *
         * @see com.wade.container.server.server.HttpParser.EventHandler#messageComplete(int)
         */
        @Override
        public void messageComplete(long contentLength) throws IOException
        {
         ...
         * (non-Javadoc)
         *
         * @see com.wade.container.server.server.HttpParser.EventHandler#startResponse(org.eclipse.io.Buffer, int,
         ...
         * (non-Javadoc)
         *
         * @see com.wade.container.server.server.HttpParser.EventHandler#earlyEOF()
         */
        @Override
        public void earlyEOF()
        {
