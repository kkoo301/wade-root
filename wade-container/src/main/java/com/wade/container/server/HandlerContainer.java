 ...
 * <p>
 * The contained handlers may be one (see @{link {@link server.handler.HandlerWrapper})
 * or many (see {@link server.handler.HandlerList} or {@link server.handler.HandlerCollection}. 
 *
 */
