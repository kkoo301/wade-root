...
import com.wade.container.security.RunAsToken;
...
public class ServletHolder extends Holder<Servlet> implements UserIdentity.Scope, Comparable
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see com.wade.container.server.UserIdentity.Scope#getContextPath()
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see com.wade.container.server.UserIdentity.Scope#getRoleRefMap()
     */
