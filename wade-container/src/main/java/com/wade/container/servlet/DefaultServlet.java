...
package com.wade.container.servlet;
...
import com.wade.container.io.WriterOutputStream;
...
import com.wade.container.server.HttpOutput;
import com.wade.container.server.InclusiveByteRange;
import com.wade.container.server.ResourceCache;
...
import com.wade.container.util.MultiPartOutputStream;
...
import com.wade.container.util.resource.FileResource;
import com.wade.container.util.resource.Resource;
import com.wade.container.util.resource.ResourceCollection;
import com.wade.container.util.resource.ResourceFactory;
...
public class DefaultServlet extends HttpServlet implements ResourceFactory
{
    ...
    {
        String value=getServletContext().getInitParameter("com.wade.container.servlet.Default."+name);
        if (value==null)
    ...
    throws ServletException, IOException
    {
        ...
        try
        {
            ...
            else
            {
                ...
                if (!endsWithSlash || (pathInContext.length()==1 && request.getAttribute("com.wade.container.server.nullPathInfo")!=null))
                {
                ...
                else if (null!=(welcome=getWelcomeFile(pathInContext)))
                {
                    ...
                    else
                    {
                        ...
                        if (dispatcher!=null)
                        {
                            ...
                            {
                                request.setAttribute("com.wade.container.server.welcome",welcome);
