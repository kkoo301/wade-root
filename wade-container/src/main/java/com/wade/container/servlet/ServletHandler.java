...
import com.wade.container.http.PathMap;
...
import com.wade.container.server.ServletRequestHttpWrapper;
import com.wade.container.server.ServletResponseHttpWrapper;
import com.wade.container.server.UserIdentity;
import com.wade.container.server.handler.ContextHandler;
import com.wade.container.server.handler.ScopedHandler;
 ...
 * then this handler should be used as part of a <code>webapp.WebAppContext</code>.
 * <p>
...
public class ServletHandler extends ScopedHandler
{
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see com.wade.container.server.handler.AbstractHandler#setServer(server.Server)
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see com.wade.container.server.Handler#handle(javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse, int)
     */
    @Override
