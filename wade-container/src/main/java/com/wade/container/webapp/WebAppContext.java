...
import com.wade.container.security.SecurityHandler;
import com.wade.container.server.Connector;
import com.wade.container.server.HandlerContainer;
import com.wade.container.server.Server;
import com.wade.container.server.handler.ContextHandler;
import com.wade.container.server.handler.ErrorHandler;
import com.wade.container.server.session.SessionHandler;
import com.wade.container.servlet.ErrorPageErrorHandler;
import com.wade.container.servlet.ServletContextHandler;
import com.wade.container.servlet.ServletHandler;
import com.wade.container.util.LazyList;
import com.wade.container.util.Loader;
import com.wade.container.util.MultiException;
import com.wade.container.util.StringUtil;
import com.wade.container.util.URIUtil;
import com.wade.container.util.log.Log;
import com.wade.container.util.log.Logger;
import com.wade.container.util.resource.Resource;
import com.wade.container.util.resource.ResourceCollection;
 ...
 * {@link security.ConstraintSecurityHandler}, {@link server.session.SessionHandler}
 * and {@link servlet.ServletHandler}.
 * The handlers are configured by pluggable configuration classes, with
 * the default being  {@link webapp.WebXmlConfiguration} and
 * {@link webapp.JettyWebXmlConfiguration}.
 *
...
public class WebAppContext extends ServletContextHandler implements WebAppClassLoader.Context
{
    ...
    public static final String BASETEMPDIR = "com.wade.container.webapp.basetempdir";
    public final static String WEB_DEFAULTS_XML="com/wade/container/webapp/webdefault.xml";
    public final static String ERROR_PAGE="com.wade.container.server.error_page";
    public final static String SERVER_CONFIG = "com.wade.container.webapp.configuration";
    public final static String SERVER_SYS_CLASSES = "com.wade.container.webapp.systemClasses";
    public final static String SERVER_SRV_CLASSES = "com.wade.container.webapp.serverClasses";
    
    private String[] __dftProtectedTargets = {"/web-inf", "/meta-inf"};
    
    private static String[] __dftConfigurationClasses =
    {
        "com.wade.container.webapp.WebInfConfiguration",
        "com.wade.container.webapp.WebXmlConfiguration",
        "com.wade.container.webapp.MetaInfConfiguration",
        "com.wade.container.webapp.FragmentConfiguration",
        "com.wade.container.webapp.JettyWebXmlConfiguration",
        "com.wade.container.webapp.TagLibConfiguration"
    } ;
    ...
    public final static String[] __dftSystemClasses =
    {
        ...
        "com.wade.container.continuation.",  // webapp cannot change continuation classes
        "com.wade.container.jndi.",          // webapp cannot change naming classes
        "com.wade.container.plus.jaas.",     // webapp cannot change jaas classes
        "com.wade.container.websocket.WebSocket", // WebSocket is a jetty extension
        "com.wade.container.websocket.WebSocketFactory", // WebSocket is a jetty extension
        "com.wade.container.websocket.WebSocketServlet", // webapp cannot change WebSocketServlet
        "com.wade.container.servlet.DefaultServlet" // webapp cannot change default servlets
    } ;
    ...
    {
        "-com.wade.container.continuation.", // don't hide continuation classes
        "-com.wade.container.jndi.",         // don't hide naming classes
        "-com.wade.container.plus.jaas.",    // don't hide jaas classes
        "-com.wade.container.websocket.WebSocket", // WebSocket is a jetty extension
        "-com.wade.container.websocket.WebSocketFactory", // WebSocket is a jetty extension
        "-com.wade.container.websocket.WebSocketServlet", // don't hide WebSocketServlet
        "-com.wade.container.servlet.DefaultServlet", // don't hide default servlet
        "-com.wade.container.servlet.listener.", // don't hide useful listeners
        "com.wade.container."                // hide other jetty classes
    } ;
    ...
    private boolean _parentLoaderPriority= Boolean.getBoolean("com.wade.container.server.webapp.parentLoaderPriority");
    ...
    /* ------------------------------------------------------------ */
    /* (non-Javadoc)
     * @see com.wade.container.server.server.handler.ContextHandler#setClassLoader(java.lang.ClassLoader)
     */
    @Override
