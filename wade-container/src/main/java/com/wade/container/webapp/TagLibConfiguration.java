...
public class TagLibConfiguration extends AbstractConfiguration
{
    ...
    public static final String TLD_RESOURCES = "com.wade.container.tlds";
    ...
    public  class TagLibListener implements ServletContextListener {
        ...
        private Set<Resource> findTldResources () throws IOException {
            ...
            // the patterns defined in the context attributes: server.webapp.ContainerIncludeJarPattern,
            // and server.webapp.WebInfIncludeJarPattern
    ...
    {
        public static final String TAGLIB_PROCESSOR = "com.wade.container.tagLibProcessor";
        XmlParser _parser;
