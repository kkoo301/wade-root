...
import com.wade.container.security.ConstraintMapping;
...
import com.wade.container.servlet.FilterHolder;
import com.wade.container.servlet.FilterMapping;
import com.wade.container.servlet.JspPropertyGroupServlet;
import com.wade.container.servlet.ServletContextHandler;
import com.wade.container.servlet.ServletHandler;
import com.wade.container.servlet.ServletHolder;
import com.wade.container.servlet.ServletMapping;
...
import com.wade.container.xml.XmlParser;
...
public class StandardDescriptorProcessor extends IterativeDescriptorProcessor
{
    ...
    public static final String STANDARD_PROCESSOR = "com.wade.container.standardDescriptorProcessor";
    ...
    protected void visitServlet(WebAppContext context, Descriptor descriptor, XmlParser.Node node)
    {
        ...
        if (id != null && id.equals("jsp"))
        {
            ...
            catch (ClassNotFoundException e)
            {
                ...
                jspServletClass = servlet_class = "com.wade.container.servlet.NoJspServlet";
            }
        }
