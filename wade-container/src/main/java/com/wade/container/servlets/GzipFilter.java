...
import com.wade.container.continuation.ContinuationSupport;
import com.wade.container.http.HttpMethods;
import com.wade.container.http.gzip.CompressedResponseWrapper;
import com.wade.container.http.gzip.AbstractCompressedStream;
 ...
 * prevented, thus use of the gzip mechanism of the {@link com.wade.container.servlet.DefaultServlet} is 
 * advised instead.
 * </p>
 * <p>
...
public class GzipFilter extends UserAgentFilter
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see com.wade.container.servlets.UserAgentFilter#init(javax.servlet.FilterConfig)
     */
    @Override
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see com.wade.container.servlets.UserAgentFilter#destroy()
     */
    @Override
    public void destroy()
    {
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see com.wade.container.servlets.UserAgentFilter#doFilter(javax.servlet.ServletRequest, javax.servlet.ServletResponse, javax.servlet.FilterChain)
     */
    @Override
