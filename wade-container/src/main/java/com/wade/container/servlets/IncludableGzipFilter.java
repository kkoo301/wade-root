...
public class IncludableGzipFilter extends GzipFilter
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see com.wade.container.servlets.GzipFilter#createWrappedResponse(javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse, java.lang.String)
     */
    @Override
    ...
    private abstract class IncludableResponseWrapper extends CompressedResponseWrapper
    {
        ...
        public void setHeader(String name,String value)
        {
            ...
            if (!response.containsHeader(name))
                response.setHeader("com.wade.container.server.include."+name,value);
        }
