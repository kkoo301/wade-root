...
import static com.wade.container.util.TypeUtil.convertHexDigit;
...
import com.wade.container.util.Utf8Appendable.NotUtf8Exception;
 ...
 * passing a parameter or setting the "com.wade.container.util.UrlEncoding.charset"
 * System property.
 * <p>
...
public class UrlEncoded extends MultiMap implements Cloneable
{
    ...
    public static final String ENCODING = System.getProperty("com.wade.container.util.UrlEncoding.charset",StringUtil.__UTF8);
