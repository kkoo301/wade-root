 ...
 * <p>
 * The "com.wade.container.util.log.class" system property can be used
 * to select a specific logging implementation.
 * <p>
 * If the system property util.log.IGNORED is set,
...
public class Log
{
    ...
    static
    {
        ...
        AccessController.doPrivileged(new PrivilegedAction<Object>()
        {
            public Object run()
            {
                 ...
                 */
                __logClass = __props.getProperty("com.wade.container.util.log.class","com.wade.container.util.log.Slf4jLog");
                __ignored = Boolean.parseBoolean(__props.getProperty("com.wade.container.util.log.IGNORED","false"));
                return null;
            }
        });
    }
    ...
    public static void setLogToParent(String name)
    {
        ...
        if (loader!=null && loader.getParent()!=null)
        {
            try
            {
                Class<?> uberlog = loader.getParent().loadClass("com.wade.container.util.log.Log");
