...
import com.wade.container.http.HttpTokens;
            ...
            while (attr_type != 0xFF)
            {
                switch (attr_type)
                {
                    ...
                    case Ajp13RequestHeaders.JVM_ROUTE_ATTR:
                        ...
                        // used in com.wade.container.servlet.HashSessionIdManager
                        _handler.parsedRequestAttribute("com.wade.container.ajp.JVMRoute", Ajp13RequestPacket.getString(_buffer, _tok1));
                        break;
