...
/**
 * OracleCallableStatement 对象
 * 
 * @className: OracleCallableStatement.java
 * @author: liaosheng
 * @date: 2014-3-24
 */
public class OracleCallableStatement implements CallableStatement {
	private static final Logger log = Logger.getLogger(OracleCallableStatement.class);
	...
	public OracleCallableStatement(ConnectionWrapper proxyConnection, CallableStatement stmt) throws SQLException {
		if (log.isDebugEnabled()) {
			log.debug(String.format("创建OracleCallableStatement,queryTimeout=%d.", proxyConnection.getStmtTimeout()));
		}
	...
	public OracleCallableStatement(ConnectionWrapper proxyConnection, CallableStatement stmt, String prepareSQL) throws SQLException {
		if (log.isDebugEnabled()) {
			log.debug(String.format("创建OracleCallableStatement,queryTimeout=%d.", proxyConnection.getStmtTimeout()));
		}
	...
	public CallableStatement getProxyStatement() {
		return this.stmt;
	}
