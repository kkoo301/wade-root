...
/**
 * AltibaseCallableStatement 对象
 * 
 * @className: MySQLCallableStatement.java
 * @author: liaosheng
 * @date: 2014-3-24
 */
public class AltibaseCallableStatement implements CallableStatement {
private static final Logger log = Logger.getLogger(AltibaseCallableStatement.class);
	
	private CallableStatement stmt;
	
	private ConnectionWrapper proxyConnection = null;
	
	public AltibaseCallableStatement(ConnectionWrapper proxyConnection, CallableStatement stmt) throws SQLException {
		if (log.isDebugEnabled()) {
			log.debug(String.format("创建AltibaseCallableStatement,queryTimeout=%d.", proxyConnection.getStmtTimeout()));
		}
