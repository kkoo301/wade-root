...
public class MySQLCallableStatement implements CallableStatement {
	private static final Logger log = Logger.getLogger(MySQLCallableStatement.class);
	
	private CallableStatement stmt;
	
	private ConnectionWrapper proxyConnection = null;
	
	public MySQLCallableStatement(ConnectionWrapper proxyConnection, CallableStatement stmt) throws SQLException {
		if (log.isDebugEnabled()) {
			log.debug(String.format("创建MySQLCallableStatement,queryTimeout=%d.", proxyConnection.getStmtTimeout()));
		}
