 ...
 * 基于ORM的表结构对象
 */
public class ORMOracleTableMetaData extends TableMetaData {

	private static final Logger log = Logger.getLogger(ORMOracleTableMetaData.class);
	...
	public ORMOracleTableMetaData(DataSourceWrapper ds) {
		super(ds);
	}
