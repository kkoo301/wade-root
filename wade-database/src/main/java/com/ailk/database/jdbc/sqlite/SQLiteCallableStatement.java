...
/**
 * SQLiteCallableStatement 对象
 * 
 * @className: SQLiteCallableStatement.java
 * @author: liaosheng
 * @date: 2014-3-24
 */
public class SQLiteCallableStatement implements CallableStatement {
	private static final Logger log = Logger.getLogger(SQLiteCallableStatement.class);
	
	private CallableStatement stmt;
	
	private ConnectionWrapper proxyConnection = null;
	
	public SQLiteCallableStatement(ConnectionWrapper proxyConnection, CallableStatement stmt) throws SQLException {
		if (log.isDebugEnabled()) {
			log.debug(String.format("创建SQLiteCallableStatement,queryTimeout=%d.", proxyConnection.getStmtTimeout()));
		}
