 ...
 * the System property <strong>com.ailk.rpc.org.jboss.netty.tryUnsafe</strong> with
...
public final class DetectionUtil {
    ...
    private static boolean hasUnsafe(ClassLoader loader) {
        ...
        if (SystemPropertyUtil.contains("io.netty.tryUnsafe")) {
            ...
            tryUnsafe = SystemPropertyUtil.getBoolean("com.ailk.rpc.org.jboss.netty.tryUnsafe", true);
        }
