 ...
 * The main interface is <tt>{@link com.ailk.rpc.org.jboss.netty.handler.ipfilter.IpFilteringHandler}</tt> which
 * all filters will extend.</P>
 *
 * <P>Two IP filtering are proposed:<br>
 * <ul>
 * <li>{@link com.ailk.rpc.org.jboss.netty.handler.ipfilter.OneIpFilterHandler}: This filter proposes to allow
 ...
 *
 * <li>{@link com.ailk.rpc.org.jboss.netty.handler.ipfilter.IpFilterRuleHandler}: This filter proposes to allow
 ...
 * operations).<br><br>
 * Per default implementation this method invokes an {@link com.ailk.rpc.org.jboss.netty.handler.ipfilter.IpFilterListener}
 ...
 *
 * <pre>
 * {@link com.ailk.rpc.org.jboss.netty.channel.ChannelPipeline} pipeline = ...;
 *
