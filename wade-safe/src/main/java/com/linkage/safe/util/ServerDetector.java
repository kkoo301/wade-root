...
/**
 * 
 * @author $Id: ServerDetector.java 1 2014-02-20 08:34:02Z huangbo $
 *
 */
public class ServerDetector {
	...
	public static final String JETTY_CLASS = "/org/mortbay/jetty/Server.class"; // /org/mortbay/jetty/Server.class
	
	public static final String JETTY7_CLASS = "/org/eclipse/jetty/server/Server.class";
	...
	public static boolean isJetty() {
		...
		if (sd._jetty == null) {
			...
			}else if(c.getResource(JETTY7_CLASS) != null){
				sd._jetty = Boolean.TRUE;
			}
			else {
